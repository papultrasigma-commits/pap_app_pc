...
import { User, Settings, Link as LinkIcon, Shield, Swords, Crosshair, TrendingUp, LogOut, Loader2, ArrowLeft, Heart, MessageCircle, Send, CheckCircle2, Trash2, Image as ImageIcon, X } from 'lucide-react';
    ...
    <div className="bg-[#181a1b] border border-gray-800 rounded-xl overflow-hidden mb-4 transition-all hover:border-gray-700 animate-fade-in">
      ...
      {post.media_url && (
        <div className="relative w-full max-h-[400px] bg-[#0a0c0d] flex items-center justify-center border-y border-gray-800/50 overflow-hidden">
          {post.media_type === 'video' ? <video src={post.media_url} controls className="w-full max-h-[400px] object-contain" /> : <img src={post.media_url} alt="Post" className="w-full max-h-[400px] object-contain" />}
        </div>
      )}
